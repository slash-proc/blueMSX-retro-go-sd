/* CRC-32 (Ethernet / zlib polynomial), little-endian bit order.
 * Same algorithm as firmware linux/crc32.c — used for SMSPlus game DB lookup. */
#include "porting/crc32.h"
